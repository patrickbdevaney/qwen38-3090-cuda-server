...
"                         Always required: it supplies config.json and\n"
"                         tokenizer.json even when --gguf supplies weights.\n"
"  --gguf FILE            take the WEIGHTS from a GGUF instead. Measured on\n"
"                         UD-Q3_K_XL: same accuracy against BF16 as AWQ (KL\n"
"                         1.43e-01 vs 1.50e-01, top-1 98.57%% vs 98.56%%) for\n"
"                         11.36 GiB of weights instead of 13.06 -- 99k more\n"
"                         tokens of INT4 KV. It decodes slower: the block\n"
"                         GEMV runs at ~61%% of llama.cpp effective. Pick AWQ\n"
"                         for throughput, GGUF for context.\n"
